...
export function PcListPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader eyebrow="SE Lab inventory" title="Lab PCs" description="Browse the workstation inventory and current availability." action={<Link to="/book"><Button><Plus size={17} />Create request</Button></Link>} />
