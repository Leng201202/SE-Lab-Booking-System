...
export function PendingRequestsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader eyebrow={`${user.role} review`} title={user.role === 'advisor' ? 'Pending requests' : 'Pending approval'} description={user.role === 'advisor' ? 'Review assigned Student requests before forwarding them to the Dean.' : 'Review Student requests approved by Advisors and requests submitted directly by Advisors.'} />
